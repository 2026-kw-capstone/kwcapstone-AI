...
6. 각 step의 assistantMessage는 실제 현장에서 상대방이 할 법한 자연스러운 구어체여야 함.
7. 난이도가 올라갈수록 돌발 상황, 추가 조건, 더 복잡한 질문 등을 포함해 실제 대화 압박을 높여야 함.
8. 반드시 JSON만 반환해야 함.
9. JSON 바깥의 설명 문장, 마크다운 코드블록, 주석은 절대 포함하지 말 것.
